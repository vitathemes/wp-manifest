                ...
                <div class="comment-content">
                    <div class="comment-header">
                        ...
                        if (get_comment_author_url($comment) != "") {
	                        printf('<div class="comment-author"><a href="%1$s">%2$s</a></div>', esc_url(get_comment_author_url($comment)), esc_html(get_comment_author($comment)));
                        } else {
					...
					<?php
					// Output Edit link
					edit_comment_link(__('Edit', 'wp-manifest'), '<span class="edit-link">', '</span>');
