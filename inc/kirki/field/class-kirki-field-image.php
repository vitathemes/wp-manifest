...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'wp-manifest' ),
				'change'       => esc_html__( 'Change image', 'wp-manifest' ),
				'default'      => esc_html__( 'Default', 'wp-manifest' ),
				'remove'       => esc_html__( 'Remove', 'wp-manifest' ),
				'placeholder'  => esc_html__( 'No image selected', 'wp-manifest' ),
				'frame_title'  => esc_html__( 'Select image', 'wp-manifest' ),
				'frame_button' => esc_html__( 'Choose image', 'wp-manifest' ),
			)
		);
	}
