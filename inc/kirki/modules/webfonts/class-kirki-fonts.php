...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'wp-manifest' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'wp-manifest' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'wp-manifest' ),
			'200'       => esc_html__( 'Light 200', 'wp-manifest' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'wp-manifest' ),
			'300'       => esc_html__( 'Book 300', 'wp-manifest' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'wp-manifest' ),
			'400'       => esc_html__( 'Normal 400', 'wp-manifest' ),
			'regular'   => esc_html__( 'Normal 400', 'wp-manifest' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'wp-manifest' ),
			'500'       => esc_html__( 'Medium 500', 'wp-manifest' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'wp-manifest' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'wp-manifest' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'wp-manifest' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'wp-manifest' ),
			'700'       => esc_html__( 'Bold 700', 'wp-manifest' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'wp-manifest' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'wp-manifest' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'wp-manifest' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'wp-manifest' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'wp-manifest' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'wp-manifest' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'wp-manifest' ),
		);
	}
