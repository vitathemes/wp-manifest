	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'wp-manifest' ),
				'remove'               => esc_html__( 'Remove', 'wp-manifest' ),
				'default'              => esc_html__( 'Default', 'wp-manifest' ),
				'selectFile'           => esc_html__( 'Select File', 'wp-manifest' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'wp-manifest' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'wp-manifest' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'wp-manifest' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'wp-manifest' ),
			)
		);
