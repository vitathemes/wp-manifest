...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'wp-manifest' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'wp-manifest' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'wp-manifest' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'wp-manifest' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'wp-manifest' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'wp-manifest' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'wp-manifest' ); ?>',
} );
#>
